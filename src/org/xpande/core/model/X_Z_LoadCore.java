...
public class X_Z_LoadCore extends PO implements I_Z_LoadCore, I_Persistent 
{
...
// N
    ...
    /** Load Constructor */
    public X_Z_LoadCore (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_Z_LoadCore[")
	...
	/** Set TipoLoadCore.
	  ...
	  */
	public void setTipoLoadCore (String TipoLoadCore)
	{

		set_Value (COLUMNNAME_TipoLoadCore, TipoLoadCore);
	}

	/** Get TipoLoadCore.
		@return Lista de valores para tipos de datos básicos a cargar en el sistema
	  */
	public String getTipoLoadCore () 
	{
		return (String)get_Value(COLUMNNAME_TipoLoadCore);
	}
	...
	{
		if (Z_LoadCore_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_Z_LoadCore_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_Z_LoadCore_ID, Integer.valueOf(Z_LoadCore_ID));
	}
