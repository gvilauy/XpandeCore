...
public class X_Z_DocReference extends PO implements I_Z_DocReference, I_Persistent 
{
    ...
    public X_Z_DocReference (Properties ctx, int Z_DocReference_ID, String trxName)
    {
      ...
      /** if (Z_DocReference_ID == 0)
        {
			setAD_Table_ID (0);
			setRecord_ID (0);
			setZ_DocReference_ID (0);
        } */
    }

    /** Load Constructor */
    public X_Z_DocReference (Properties ctx, ResultSet rs, String trxName)
    {
    ...
    {
      StringBuffer sb = new StringBuffer ("X_Z_DocReference[")
	...
	/** Set Z_DocReference ID.
		@param Z_DocReference_ID Z_DocReference ID	  */
	public void setZ_DocReference_ID (int Z_DocReference_ID)
	{
		if (Z_DocReference_ID < 1) 
			set_ValueNoCheck (COLUMNNAME_Z_DocReference_ID, null);
		else 
			set_ValueNoCheck (COLUMNNAME_Z_DocReference_ID, Integer.valueOf(Z_DocReference_ID));
	}

	/** Get Z_DocReference ID.
		@return Z_DocReference ID	  */
	public int getZ_DocReference_ID () 
	{
		Integer ii = (Integer)get_Value(COLUMNNAME_Z_DocReference_ID);
		if (ii == null)
			 return 0;
		return ii.intValue();
	}
